...
describe('DataTableComponent', () => {
  ...
  describe('data display', () => {
    ...
    it('should render table with data', () => {
      const rows = compiled.queryAll(By.css('tr.mat-mdc-row'));
      expect(rows.length).toBe(3);
    });

    it('should display column headers', () => {
      const headers = compiled.queryAll(By.css('th.mat-mdc-header-cell'));
    ...
    it('should display cell data correctly', () => {
      const firstRow = compiled.queryAll(By.css('tr.mat-mdc-row'))[0];
  ...
  describe('search functionality', () => {
    ...
    it('should update searchTerm when input changes', () => {
      const searchInput = compiled.query(By.css('input[matInput]'));
  ...
  describe('pagination', () => {
    ...
    it('should display paginator with correct settings', () => {
      const paginator = compiled.query(By.css('mat-paginator'));
  ...
  describe('edge cases', () => {
    ...
    it('should handle single row', () => {
      component.columns = testColumns;
      component.dataSource = new MatTableDataSource([testData[0]]);
